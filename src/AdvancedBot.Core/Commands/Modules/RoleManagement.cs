...
namespace AdvancedBot.Core.Commands.Modules
{
    ...
    {
        [Command("addrole")][Alias("ar")][RequireUserPermission(GuildPermission.ManageRoles)]
        ...
        [Command("removerole")][Alias("rr")][RequireUserPermission(GuildPermission.ManageRoles)]
